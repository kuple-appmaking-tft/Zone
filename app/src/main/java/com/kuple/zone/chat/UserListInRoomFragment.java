...
public class UserListInRoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_user_list_in_room, container, false);
        ...
        view.findViewById(R.id.btn_out).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                // You have to make the code for delete this room from database
            }
        });
    ...
    class UserFragmentRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            customViewHolder.user_name.setText(user.getUserName());
